...
1.  **Traducción Integral:** Basada en el excelente trabajo de [Thord82](https://github.com/Thord82/Star_citizen_ES), cubriendo textos, diálogos y menús en la versión 4.7.1
...
1. **Descarga el paquete:** [Aqui]([https://github.com/SigmundBathory/Star-Citizen/archive/refs/heads/main.zip](https://github.com/SigmundBathory/Star-Citizen/blob/main/Star_citizen_ES.zip)) y baja el archivo `.zip`.
